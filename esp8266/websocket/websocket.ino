...
char myssid[] = "DaniyalM-phone";         // your network SSID (name)
char mypass[] = "Test1234";          // your network password
...
void loop() {
  ...
  else
  {
    ...
    if (more_text) {
      ...
      Serial.println("{");
      Serial.println("\"homeMobileCountryCode\": 302,");  // this is a real UK MCC
      Serial.println("\"homeMobileNetworkCode\": 720,");   // and a real UK MNC
      Serial.println("\"radioType\": \"gsm\",");          // for gsm
      Serial.println("\"carrier\": \"Rogers AT&T Wireless\",");       // associated with Vodafone
